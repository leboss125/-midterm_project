  ...
  return knex('menu_items').del()
    .then(function () {
      return Promise.all([
        ...
        knex('menu_items').insert({name: 'SUPERFOOD SALAD', restaurent_id: 1, price:14.99, decription:'baby spinach, kale, arugula, quinoa, mint, parsley, avocado, broccoli, cherry tomatoes, roasted sweet potato, pomegranate seeds, apples'}),
